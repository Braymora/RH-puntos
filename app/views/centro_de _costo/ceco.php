...
$query = "SELECT ce.id_ceco, ce.nombre_ceco FROM ceco ce";
...
<body>
        ...
        <div class="contCreatecontract">
            <div class="cont-contract">
                <div class="contCreatecontract-info">
                    ...
                    <h1 class="contCreatecontract-info__title">Centro de costo</h1>
                </div>
                <form class="contentInfo-inputs" id="register_user">
                    <div class="inputGroup">
                        <input type="text" name="codigo_ceco" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Codico ceco</label>
                    </div>

                    <div class="inputGroup">
                        <input type="text" name="nombre_ceco" required="" autocomplete="off" class="usuario">
        ...
        <div class="main_table">
            <div class="cont-table">
                <div class="table-container">
                    ...
                    <table class="responsive-table" id="table_ceco">
                        <thead>
                            <tr>
                                <th>Codigo ceco</th>
                                <th>Nombre ceco</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td data-label="Id"><?php echo $data['id_ceco'] ?></td>
                                        <td data-label="nombre ceco"><?php echo $data['nombre_ceco'] ?></td>
                                        <td data-label="opciones">
                                            <button class="button type2 edit-button" data-ceco="<?php echo $data['id_ceco']; ?>" data-name="<?php echo $data['nombre_ceco']; ?>">
                                                Editar
                                            </button>
                                            <button class="buttonDelete typeDelete" value="<?php echo $data['id_ceco'] ?>"></button>
                                        </td>
                                    </tr>
                            <?php
                                }
        ...
        <div id="editModal" class="modal">
            <div class="modal-content">
                ...
                <form class="contentInfo-inputs" id="editForm">
                    <div class="inputGroup">
                        <input type="text" name="codigo_ceco" id="codigo_cecoUp" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Código ceco</label>
                    </div>
                    <div class="inputGroup">
                        <input type="text" name="nombre_ceco" id="name_cecoUp" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Nombre ceco</label>
                    </div>
                    <button class="BtnCon" type="submit">
                        <span class="IconContainer">
    ...
    <script src="../../../script/ceco/guardar_datos.js"></script>
    <script src="../../../script/ceco/update_delete_momdal.js"></script>
