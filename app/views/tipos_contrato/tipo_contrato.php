...
$query = "SELECT tp.id_tipo_contrato, tp.nombre_tipo_contrato FROM tipo_contrato tp";
...
<head>
    ...
    <link rel="stylesheet" href="../../../style/tipos_contrato/tipo_contrato.css">
...
<body>
    ...
    <main class="main">
        ...
        <div class="contCreatecontract">
            <div class="cont-contract">
                <div class="contCreatecontract-info">
                    <img src="../../../assets/icons/file-text.svg" alt="Imagen para editar" class="contCreatecontract-info__image">
                    <h1 class="contCreatecontract-info__title">Tipos de Contrato</h1>
                </div>
                <form class="contentInfo-inputs" id="register_tipo_contrato">
                    <div class="inputGroup">
                        <input type="text" name="codigo_tipo_contrato" required="" autocomplete="off" class="tipo_contrato">
                        <label for="tipeContrat">Codigo tipo contrato</label>
                    </div>

                    <div class="inputGroup">
                        <input type="text" name="nombre_tipo_contrato" required="" autocomplete="off" class="tipo_contrato">
                        <label for="tipeContrat">Tipo de Contrato</label>
                    </div>
        ...
        <div class="main_table">
            <div class="cont-table">
                <div class="table-container">
                    ...
                    <table class="responsive-table" id="table_tipo_contrato">
                        <thead>
                            <tr>
                                <th>Codigo</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td data-label="Codigo"><?php echo $data['id_tipo_contrato'] ?></td>
                                        <td data-label="Nombre_tipo_contrato"><?php echo $data['nombre_tipo_contrato'] ?></td>
                                        <td data-label="opciones">
                                            <button class="button type2 edit-button" data-tipo-contrato="<?php echo $data['id_tipo_contrato']; ?>" data-name="<?php echo $data['nombre_tipo_contrato']; ?>">
                                                Editar
                                            </button>
                                            <button class="buttonDelete typeDelete" value="<?php echo $data['id_tipo_contrato'] ?>"></button>
                                        </td>
                                    </tr>
                            <?php
                                }
        ...
        <!-- =============Modal para editar tipo de contrato======== -->
        <!-- Modal -->
        <div id="editModal" class="modal">
            <div class="modal-content">
                ...
                <form class="contentInfo-inputs" id="editForm">
                    <div class="inputGroup">
                        <input type="text" name="codigo_tipo_contrato" id="codigo_tipo_contratoUp" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Código contrato</label>
                    </div>
                    <div class="inputGroup">
                        <input type="text" name="nombre_tipo_contrato" id="name_tipo_contratoUp" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Tipo de Contrato</label>
                    </div>
                    <button class="BtnCon" type="submit">
                        <span class="IconContainer">
        ...
        <!-- ===========Modal alert eliminar tipo de contrato========== -->
        <div id="confirmModal" class="modal">
            <div class="modal-content">
                <input type="hidden" value="<?php echo $dataTmpPuntos['id_tipo_contrato']; ?>">
                <h2>Confirmar eliminación</h2>
                <p>¿Estás seguro de que quieres eliminar este dato?</p>
                <div class="conbutton">
                    <button id="cancelBtn">Cancelar</button>
                    <button id="deleteBtn" value="<?php echo $dataTmpPuntos['id_tipo_contrato'] ?>">Eliminar</button>
                </div>
            </div>
        </div>
...
=============== -->
    ...
    <script src="../../../script/tipos_contrato/guardar_datos.js"></script>
    <script src="../../../script/tipos_contrato/update_delete_momdal.js"></script>
