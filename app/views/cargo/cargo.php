...
$query = "SELECT cr.id_cargo, cr.nombre_cargo FROM cargos cr";
...
<head>
    ...
    <link rel="stylesheet" href="../../../style/cargo/cargo.css">
...
<body>
    ...
    <main class="main">
        ...
        <div class="contCreatecontract">
            <div class="cont-contract">
                <div class="contCreatecontract-info">
                    <img src="../../../assets/icons/file-textTwo.svg" alt="Imagen para editar" class="contCreatecontract-info__image">
                    <h1 class="contCreatecontract-info__title">Cargo</h1>
                </div>
                <form class="contentInfo-inputs" id="register_user">
                    <div class="inputGroup">
                        <input type="text" name="codigo_cargo" required="" autocomplete="off" class="cargo">
                        <label for="tipeContrat">Codigo cargo</label>
                    </div>

                    <div class="inputGroup">
                        <input type="text" name="nombre_cargo" required="" autocomplete="off" class="cargo">
                        <label for="tipeContrat">Nombre cargo</label>
                    </div>
        ...
        <div class="main_table">
            <div class="cont-table">
                <div class="table-container">
                    ...
                    <table class="responsive-table" id="table_cargo">
                        <thead>
                            <tr>
                                <th>Codigo</th>
                                <th>Nombre cargo</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td data-label="Codigo"><?php echo $data['id_cargo'] ?></td>
                                        <td data-label="Nombre cargo"><?php echo $data['nombre_cargo'] ?></td>
                                        <td data-label="opciones">
                                            <button class="button type2 edit-button" data-cargo="<?php echo $data['id_cargo']; ?>" data-name="<?php echo $data['nombre_cargo']; ?>">
                                                Editar
                                            </button>
                                            <button class="buttonDelete typeDelete" value="<?php echo $data['id_cargo'] ?>"></button>
                                        </td>
                                    </tr>
                            <?php
                                }
        ...
        <div id="editModal" class="modal">
            <div class="modal-content">
                ...
                <form class="contentInfo-inputs" id="editForm">
                    <div class="inputGroup">
                        <input type="text" name="codigo_cargo" id="codigo_cargoUp" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Código ceco</label>
                    </div>
                    <div class="inputGroup">
                        <input type="text" name="nombre_cargo" id="name_cargoUp" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Nombre ceco</label>
                    </div>
                    <button class="BtnCon" type="submit">
                        <span class="IconContainer">
                            <img src="../../../assets/icons/save.svg" alt="iconSearch">
        ...
        <div id="confirmModal" class="modal">
            <div class="modal-content">
                <input type="hidden" value="<?php echo $dataTmpPuntos['id_cargo']; ?>">
                <h2>Confirmar eliminación</h2>
                <p>¿Estás seguro de que quieres eliminar este dato?</p>
                <div class="conbutton">
                    <button id="cancelBtn">Cancelar</button>
                    <button id="deleteBtn" value="<?php echo $dataTmpPuntos['id_cargo'] ?>">Eliminar</button>
                </div>
            </div>
        </div>
...
=============== -->
    ...
    <script src="../../../script/cargo/guardar_datos.js"></script>
    <script src="../../../script/cargo/update_delete_momdal.js"></script>
