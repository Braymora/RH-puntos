...
$query = "SELECT cd.id_ciudad, cd.nombre_ciudad FROM ciudades cd";
...
<head>
    ...
    <link rel="stylesheet" href="../../../style/ciudades/ciudad.css">
...
<body>
    ...
    <main class="main">
        ...
        <div class="contCreatecontract">
            <div class="cont-contract">
                <div class="contCreatecontract-info">
                    <img src="../../../assets/icons/home.svg" alt="Imagen para editar" class="contCreatecontract-info__image">
                    <h1 class="contCreatecontract-info__title">Ciudad</h1>
                </div>
                <form class="contentInfo-inputs" id="register_ciudad">
                    <div class="inputGroup">
                        <input type="text" name="codigo_ciudad" required="" autocomplete="off" class="ciudad">
                        <label for="tipeContrat">Codigo Ciudad</label>
                    </div>

                    <div class="inputGroup">
                        <input type="text" name="nombre_ciudad" required="" autocomplete="off" class="ciudad">
                        <label for="tipeContrat">Nombre Ciudad</label>
                    </div>
        ...
        <div class="main_table">
            <div class="cont-table">
                <div class="table-container">
                    ...
                    <table class="responsive-table" id="table_ciudad">
                        <thead>
                            <tr>
                                <th>Codigo</th>
                                <th>Ciudad</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td data-label="Codigo"><?php echo $data['id_ciudad'] ?></td>
                                        <td data-label="Nombre ciudad"><?php echo $data['nombre_ciudad'] ?></td>
                                        <td data-label="opciones">
                                            <button class="button type2 edit-button" data-ciudad="<?php echo $data['id_ciudad']; ?>" data-name="<?php echo $data['nombre_ciudad']; ?>">
                                                Editar
                                            </button>
                                            <button class="buttonDelete typeDelete" value="<?php echo $data['id_ciudad'] ?>"></button>
                                        </td>
                                    </tr>
                            <?php
                                }
        ...
        <div id="editModal" class="modal">
            <div class="modal-content">
                ...
                <form class="contentInfo-inputs" id="editForm">
                    <div class="inputGroup">
                        <input type="text" name="codigo_ciudad" id="codigo_ciudadUp" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Código ciudad</label>
                    </div>
                    <div class="inputGroup">
                        <input type="text" name="nombre_ciudad" id="name_ciudadUp" required="" autocomplete="off" class="usuario">
                        <label for="tipeContrat">Nombre ciudad</label>
                    </div>
                    <button class="BtnCon" type="submit">
                        <span class="IconContainer">
        ...
        <div id="confirmModal" class="modal">
            <div class="modal-content">
                <input type="hidden" value="<?php echo $dataTmpPuntos['id_ciudad']; ?>">
                <h2>Confirmar eliminación</h2>
                <p>¿Estás seguro de que quieres eliminar este dato?</p>
                <div class="conbutton">
                    <button id="cancelBtn">Cancelar</button>
                    <button id="deleteBtn" value="<?php echo $dataTmpPuntos['id_ciudad'] ?>">Eliminar</button>
                </div>
            </div>
        </div>
...
=============== -->
    ...
    <script src="../../../script/ciudad/guardar_datos.js"></script>
    <script src="../../../script/ciudad/update_delete_momdal.js"></script>
