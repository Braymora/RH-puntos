...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $nombre = $_FILES['pdf-upload']['name'];
    $tmp_ruta = $_FILES['pdf-upload']['tmp_name'];
    $ubicacion = "../../files/ordenes/" . $nombre;
    ...
    try {
        ...
        if ($result) {
            ...
            $checkQuery = "SELECT id_orden FROM pdf_colaborador WHERE id_orden = :idServicio";
            ...
            $insertQuery = "INSERT INTO pdf_colaborador (id_orden, pdf) VALUES (:idServicio, :pdfFileName)";
            ...
            $updateQuery = "UPDATE ordenes_servicios SET id_estadoOrden = 1 WHERE id_servicio = :idServicio";
