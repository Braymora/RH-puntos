...
editButtons.forEach(function (button) {
  button.addEventListener("click", function () {
    // Obtén los valores de data-cargo y data-name del botón
    var cargoId = this.getAttribute("data-cargo");
    var nombreCargo = this.getAttribute("data-name");

    // Rellena el formulario en el modal con los valores
    editForm.elements.codigo_cargo.value = cargoId;
    editForm.elements.nombre_cargo.value = nombreCargo;
...
editForm.addEventListener("submit", function (event) {
  ...
  var id_cargo = $("#codigo_cargoUp").val();
  var name_cargo = $("#name_cargoUp").val();
  ...
  $.ajax({
    type: "POST",
    url: "../../../app/includes/cargo/actualizar.php",
    data: {
      id_cargo: id_cargo,
      name_cargo: name_cargo
    },
...
$(document).ready(function () {
  $(".buttonDelete").click(function () {
    ...
    $("#deleteBtn").click(function () {
      $.ajax({
        url: "../../../app/includes/cargo/eliminar.php",
        type: "POST",
        data: {
          idcargo: idcargo,
        },
