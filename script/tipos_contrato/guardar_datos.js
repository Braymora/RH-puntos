...
$(document).ready(function () {
    var table = $("#table_tipo_contrato").DataTable({
      searching: false,
      language: {
    ...
    $("#customSearch").on("keyup", function () {
      ...
      $("#table_tipo_contrato tbody tr").hide();
      $("#table_tipo_contrato tbody tr")
        .filter(function () {
  ...
  $(document).ready(function () {
    $("#register_tipo_contrato").submit(function (e) {
      e.preventDefault();
  
      //Obtener datos del formulario
      var codigo_tipo_contrato = $('input[name="codigo_tipo_contrato"]').val();
      var nombre_tipo_contrato = $('input[name="nombre_tipo_contrato"]').val();
  
  
      //Realizar solución AJAX
      $.ajax({
        type: "POST",
        url: "../../../app/includes/tipos_contrato/guardar_datos.php",
        data: {
          codigo_tipo_contrato: codigo_tipo_contrato,
